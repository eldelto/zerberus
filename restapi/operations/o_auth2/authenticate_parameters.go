...
func (o *AuthenticateParams) bindClientID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *AuthenticateParams) bindRedirectURI(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *AuthenticateParams) bindResponseType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *AuthenticateParams) bindScope(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AuthenticateParams) bindState(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
